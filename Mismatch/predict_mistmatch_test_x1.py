...
TRAIN_DATA_PATH = os.path.join(DATA_PATH, f'Xtr1.csv')
TRAIN_LABEL_PATH = os.path.join(DATA_PATH, f'Ytr1.csv')
TEST_DATA_PATH = os.path.join(DATA_PATH, f'Xte1.csv')
...
for i in range(n_training):
    for j in range(i+1):
        ...
        K_train[i, j] = mk.get_kernel(source,target)
...
for i in range(n_test):
    for j in range(n_training):
        ...
        K_test[i, j] = mk.get_kernel(source,target)
